...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		if err != nil {
			return fmt.Errorf("invalid config value 'heart:heart-always-online-count'=%q: %w", alwaysOnlineCountStr, err)
		}
		...
		if err != nil {
			return fmt.Errorf("invalid config value 'heart:blockchain-bridging-count'=%q: %w", blockchainBridgingCountStr, err)
		}
		if blockchainBridgingCount > 1 {
			// The software does not support this
			return fmt.Errorf("config value 'heart:blockchain-bridging-count' cannot be greater than 1, got %d", blockchainBridgingCount)
		}
		...
		if err != nil {
			return fmt.Errorf("invalid config value 'heart:unyt-bridging-count'=%q: %w", unytBridgingCountStr, err)
		}
		if unytBridgingCount > 1 {
			// The software does not support this
			return fmt.Errorf("config value 'heart:unyt-bridging-count' cannot be greater than 1, got %d", unytBridgingCount)
		}
